...
Our example in the prior section using "golden coins", was intended to establish some base intuition which we'll leverage in this section to explain how HTLCs work in practice.
...
This set of decrementing time-locks is critical to the operation of the system, as it ensures the atomicity property for each hop, assuming they're able to get into the chain in time.
...
With this bare foundation laid, the following questions may have come across your mind:
